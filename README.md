...
After a player has an emptie hand and round has been completed, calculate each player's final score.
...
A standard game lasts until one player has no cards in hand.
